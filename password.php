...
class password extends rcube_plugin
{
  ...
  function init()
  {
    ...
    $this->include_script('passwordrules.js');
  ...
  private function _save($curpass, $passwd)
  {
    ...
    if ($config->get('password_driver', 'sql') != 'alliance') {
      ...
      include_once ("changeOpenLDAPPwd.class.php");

      $objChangePasswd = new csChangeOpenLDAPPasswd();
      $res = $objChangePasswd->changePWD($uid,$curpass,$passwd,$passwd);
